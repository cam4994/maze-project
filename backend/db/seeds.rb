...
user1 = User.create(username: "Booty Popper")
user2 = User.create(username: "Sohyun")
user3 = User.create(username: "Nandita")
user4 = User.create(username: "Colin")
user5 = User.create(username: "Hugh Jass")
user6 = User.create(username: "Mona Lott")
user7 = User.create(username: "Ben Dover")
